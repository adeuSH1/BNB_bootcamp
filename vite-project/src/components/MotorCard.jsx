...
const MotorCard = ({ name, id, image, saleFee, rentFee, motorStatus, due }) => {
        ...
        <div className="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
          ...
          <div className="p-4 md:p-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-300 dark:hover:text-white">
              <p>Motor fee : {Web3.utils.fromWei(rentFee)} </p>
              <p>Sale fee: {Web3.utils.fromWei(saleFee)} </p>
              <p>{motorStatus === "2" ? "Available" : "Not Available"}</p>
            </h3>
            <p className="mt-3 text-gray-500">Motor Description</p>
          </div>
